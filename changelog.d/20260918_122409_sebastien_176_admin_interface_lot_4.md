...
- Nouvelle table `excludelist`, dépend de `user_id` et `group_id`, avec un contrainte unique sur ce couple de clés. Cette table liste les utilisateurs exclus de groupes.
- Nouvelles colonnes dans `group`:
...
### Ajouté
- L'administrateur peut affiner la gestion des groupes :
